...
FILES_DIRECTORY = $(ROOT_DIRECTORY)/history
...
CXXFLAGS = \
	-std=c++17 -g -Wall -O2 \
	-I $(ROOT_DIRECTORY)/
	-I $(ROOT_DIRECTORY)/files\
	-I $(ROOT_DIRECTORY)/filters\
	-I $(ROOT_DIRECTORY)/history\
...
HISTORY_OBJS = \
	$(HISTORY_DIRECTORY)/FilterCommand.o \
	$(HISTORY_DIRECTORY)/CommandManager.o \
